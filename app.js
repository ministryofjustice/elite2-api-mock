...
const referenceDomainsRouter = require('./routes/reference_domains')
...
app.use('/elite2api/api/offenders', offendersRouter)
app.use('/elite2api/api/movements', movementsRouter)
app.use('/elite2api/api/prisoners', prisonersRouter)
app.use('/elite2api/api/reference-domains', referenceDomainsRouter)
